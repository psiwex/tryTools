...
[p2112,tbl2112,stats,~] = anovan((hr),{ms mg me cd12},'model','interaction','varnames',{'Gender','Group','Session','Scale12'})
[p2212,tbl2212,stats,~] = anovan((ap),{ms mg me cd12},'model','interaction','varnames',{'Gender','Group','Session','Scale12'})
[p2312,tbl2312,stats,~] = anovan((hrv),{ms mg me cd12},'model','interaction','varnames',{'Gender','Group','Session','Scale12'})

[p2111,tbl2111,stats,~] = anovan((hr),{ms mg me cd11},'model','interaction','varnames',{'Gender','Group','Session','Scale11'})
[p2211,tbl2211,stats,~] = anovan((ap),{ms mg me cd11},'model','interaction','varnames',{'Gender','Group','Session','Scale11'})
[p2311,tbl2311,stats,~] = anovan((hrv),{ms mg me cd11},'model','interaction','varnames',{'Gender','Group','Session','Scale11'})

[p2110,tbl2110,stats,~] = anovan((hr),{ms mg me cd10},'model','interaction','varnames',{'Gender','Group','Session','Scale10'})
[p2210,tbl2219,stats,~] = anovan((ap),{ms mg me cd10},'model','interaction','varnames',{'Gender','Group','Session','Scale10'})
[p2310,tbl2310,stats,~] = anovan((hrv),{ms mg me cd10},'model','interaction','varnames',{'Gender','Group','Session','Scale10'})

[p2109,tbl2109,stats,~] = anovan((hr),{ms mg me cd09},'model','interaction','varnames',{'Gender','Group','Session','Scale9'})
[p2209,tbl2209,stats,~] = anovan((ap),{ms mg me cd09},'model','interaction','varnames',{'Gender','Group','Session','Scale9'})
[p2309,tbl2309,stats,~] = anovan((hrv),{ms mg me cd09},'model','interaction','varnames',{'Gender','Group','Session','Scale9'})

[p2108,tbl2108,stats,~] = anovan((hr),{ms mg me cd08},'model','interaction','varnames',{'Gender','Group','Session','Scale8'})
[p2208,tbl2208,stats,~] = anovan((ap),{ms mg me cd08},'model','interaction','varnames',{'Gender','Group','Session','Scale8'})
[p2308,tbl2308,stats,~] = anovan((hrv),{ms mg me cd08},'model','interaction','varnames',{'Gender','Group','Session','Scale8'})

[p2107,tbl2107,stats,~] = anovan((hr),{ms mg me cd07},'model','interaction','varnames',{'Gender','Group','Session','Scale7'})
[p2207,tbl2207,stats,~] = anovan((ap),{ms mg me cd07},'model','interaction','varnames',{'Gender','Group','Session','Scale7'})
[p2307,tbl2307,stats,~] = anovan((hrv),{ms mg me cd07},'model','interaction','varnames',{'Gender','Group','Session','Scale7'})

[p2106,tbl2106,stats,~] = anovan((hr),{ms mg me cd06},'model','interaction','varnames',{'Gender','Group','Session','Scale6'})
[p2206,tbl2206,stats,~] = anovan((ap),{ms mg me cd06},'model','interaction','varnames',{'Gender','Group','Session','Scale6'})
[p2306,tbl2306,stats,~] = anovan((hrv),{ms mg me cd06},'model','interaction','varnames',{'Gender','Group','Session','Scale6'})

[p2105,tbl2105,stats,~] = anovan((hr),{ms mg me cd05},'model','interaction','varnames',{'Gender','Group','Session','Scale5'})
[p2205,tbl2205,stats,~] = anovan((ap),{ms mg me cd05},'model','interaction','varnames',{'Gender','Group','Session','Scale5'})
[p2305,tbl2305,stats,~] = anovan((hrv),{ms mg me cd05},'model','interaction','varnames',{'Gender','Group','Session','Scale5'})

[p2104,tbl2104,stats,~] = anovan((hr),{ms mg me cd04},'model','interaction','varnames',{'Gender','Group','Session','Scale4'})
[p2204,tbl2204,stats,~] = anovan((ap),{ms mg me cd04},'model','interaction','varnames',{'Gender','Group','Session','Scale4'})
[p2304,tbl2304,stats,~] = anovan((hrv),{ms mg me cd04},'model','interaction','varnames',{'Gender','Group','Session','Scale4'})

[p2103,tbl2103,stats,~] = anovan((hr),{ms mg me cd03},'model','interaction','varnames',{'Gender','Group','Session','Scale3'})
[p2203,tbl2203,stats,~] = anovan((ap),{ms mg me cd03},'model','interaction','varnames',{'Gender','Group','Session','Scale3'})
[p2303,tbl2303,stats,~] = anovan((hrv),{ms mg me cd03},'model','interaction','varnames',{'Gender','Group','Session','Scale3'})

[p2102,tbl2102,stats,~] = anovan((hr),{ms mg me cd02},'model','interaction','varnames',{'Gender','Group','Session','Scale2'})
[p2202,tbl2202,stats,~] = anovan((ap),{ms mg me cd02},'model','interaction','varnames',{'Gender','Group','Session','Scale2'})
[p2302,tbl2302,stats,~] = anovan((hrv),{ms mg me cd02},'model','interaction','varnames',{'Gender','Group','Session','Scale2'})

[p2101,tbl2101,stats,~] = anovan((hr),{ms mg me cd01},'model','interaction','varnames',{'Gender','Group','Session','Scale1'})
[p2201,tbl2201,stats,~] = anovan((ap),{ms mg me cd01},'model','interaction','varnames',{'Gender','Group','Session','Scale1'})
[p2301,tbl2301,stats,~] = anovan((hrv),{ms mg me cd01},'model','interaction','varnames',{'Gender','Group','Session','Scale1'})
