...
X0 = genfromtxt('tryAiPrimeData.csv', delimiter=',')
X = genfromtxt('tryAiZData.csv', delimiter=',')
y1 = genfromtxt('tryAiLabels10.csv', delimiter=',')
y2 = genfromtxt('tryAiLabels20.csv', delimiter=',')
y3 = genfromtxt('tryAiLabels30.csv', delimiter=',')
