...
% nameListNR=table2cell(table3(:,1));
% [mainIndex,mainDex]=tableIndexer(subNames,nameListNR);

% table4 = readtable('TRY_lcmm_drinks_class_4groups.csv');
% nameListLMS=table2cell(table4(:,3));
% [mainIndex,mainDex]=tableIndexer(subNames,nameListLMS);
...
%[mainIndex22,mainDex1]=tableIndexer(subNames,nameListLMS);


classLms2=classLms(mainIndex22);
