...
aFeatures6d,totalLength,X1,X2=featureSelect(X, y6, featureNumber, 3)


aFeatures=np.unique(np.hstack([aFeatures0.flatten(), aFeatures1.flatten(), aFeatures3.flatten(), aFeatures4.flatten(), aFeatures5.flatten(), aFeatures6a.flatten(), aFeatures6b.flatten(), aFeatures6c.flatten(), aFeatures6d.flatten()])).flatten()
